...
def comb_c_r(ccc,f):
    ...
    dict_n = {ccc[0]:2,ccc[1]:2,ccc[2]:3}
...
def m_c(f):
    ...
    for ccc in combinations(d,2):
        ...
        if gg_cnt > 10**7+10**7: # 20 миллионов
            ...
            break
    print ("получено всего комбинаций1 ",gg_cnt)
    for ccc in combinations(d,3):
        ...
        if gg_cnt > 10**7+10**7: # 20 миллионов
            print("Может не хватить места на диске, превышен лимит комбинаций !!!")
            break
    print ("получено всего комбинаций2 ",gg_cnt1)
